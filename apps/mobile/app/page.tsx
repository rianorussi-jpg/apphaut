...
export default function HomePage(){const {data}=useClient();
 ...
 <section className="home-quick-grid" aria-label="Tus accesos rápidos"><Link href="/mis-citas" className="home-quick"><span><Icon name="calendar" size={21}/></span><strong>Mis citas</strong><small>Tu agenda</small></Link><Link href="/mis-tratamientos" className="home-quick"><span><Icon name="layers" size={21}/></span><strong>Mis planes</strong><small>Tu progreso</small></Link><Link href="/rewards" className="home-quick"><span><Icon name="gift" size={21}/></span><strong>Rewards</strong><small>{pointsBalance(data)} puntos</small></Link></section>
 ...
 <Link href="/rewards" className="rewards-banner"><span className="rewards-icon"><Icon name="gift" size={25}/></span><span><small>HAUT REWARDS</small><strong>{pointsBalance(data)} puntos</strong><em>Consulta tus beneficios y movimientos</em></span><Icon name="arrow" size={19}/></Link>
